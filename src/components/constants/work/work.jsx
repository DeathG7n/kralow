...
export default function Work() {
  return (
    ...
    <div id="work">
				...
				<p>For investors</p>
				<h2>We allocate funds to promising early stage crypto projects, nurture them (if
					required), wait for the token to be listed, and slowly exit over time making
					hefty returns.
				</h2>
				<div class="work">
					<div>
